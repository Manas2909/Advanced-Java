...
public class EmployeeSignupS2 extends HttpServlet
{
		...
		for(int i=0;i<languages.length;i++)
		{
			...
			Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/employeedatabase","root","root");
					...
					Statement stmt=con.createStatement();
						...
						PreparedStatement stmt1=con.prepareStatement("insert into employeenew values(?,?,?,?,?,?,?,?)");
			/*
			...
			*/
					...
					{
						RequestDispatcher rd=request.getRequestDispatcher("PasswordError1");
